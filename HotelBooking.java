...
public class HotelBooking {
    ...
    ArrayList<Integer> roomwithbookings = new ArrayList<Integer>();
    ...
    void bookingAdd(){
        ...
        if (isBooked(selected.getRoomNumber(),start,end)) {
            ...
            roomwithbookings.add(selected.getRoomNumber());
    ...
    private boolean isBooked(int number, int start,int end){
        if(!roomwithbookings.contains(number)){
            return true;
        }
        for(BookingInfo booking : bookings){
            if(booking.getRoomNumber()==number){
                ...
                if(booking.getStarting()<start && booking.getEnding()<end && booking.getEnding()<start && booking.getStarting()<end){
                    return true;
                }
                else if(booking.getStarting()>start && booking.getEnding()>end && booking.getEnding()>start && booking.getStarting()>end){
                    return true;
                }
            }
        }
